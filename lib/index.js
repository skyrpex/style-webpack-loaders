...
var vueLoaders = exports.vueLoaders = function vueLoaders() {
  ...
  function generateLoaders(loaders) {
    ...
    if (options.extract) {
      return _extractTextWebpackPlugin2.default.extract('vue-style-loader', sourceLoader);
    }
...
var loaders = exports.loaders = function loaders(options) {
  var output = [];
  (0, _lodash2.default)(exports.cssLoaders(options), function (loader, extension) {
    output.push({
